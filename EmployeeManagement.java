...
class Employee implements Serializable{
	...
	public Employee(int id, String name, int salary, long contact_no, String email_id,int attendance)
	{
		this.id = id;
		this.name = name;
		this.salary = salary;
		...
		this.salaryTotal= (salary/30) * attendance;
	}
...
{	
	...
	{
		System.out.println("\n--------------Employee List---------------\n");
		System.out.println(String.format("%-10s%-15s%-10s%-20s%-10s%-20s%-10s", "ID","Name","salary","contact-no","Email-Id","Attendance","Salary Payble"));
		for(Employee e : al)
		{
			int salaryTotal=(e.salary/30)*e.attendance;
			System.out.println(String.format("%-10s%-15s%-10s%-20s%-10s%-20s%-10s",e.id,e.name,e.salary,e.contact_no,e.email_id,e.attendance,salaryTotal));
		}
	}
	...
	public static void main(String[] args)
	{
		...
		try{
			...
			f = new File("D:/java/Data/EmployeeDataList.txt");
			if(f.exists())
			{
		...
		do
		{
			...
			case 1:System.out.println("\nEnter the following details to ADD list:\n");
				...
				al.add(new Employee(id, name, salary, contact_no, email_id,attendance));
				display(al);
				break;
			...
			case 3: System.out.println("\nEnter the Employee ID to EDIT the details");
					...
					for(Employee e: al)
					{
						...
						do{
							...
							case 6: System.out.println("Enter Attendance :");
									e.attendance =sc.nextInt();
									System.out.println(e+"\n");
									break;		
